...
<body>
	<div class="container">
		...
		<br> <br> <br> <a
			href="${pageContext.request.contextPath}/admin/viewBookings"></a>
		...
		<div class="row text-center">
			...
			<div class="col-sm-6 col-md-2">
				<form
					action="${pageContext.request.contextPath}/admin/viewMaintenances">
					<input id="btn-show-maintenances" type="submit"
						name="btnShowMaintenances" value="Display Maintenance"
						class="btn-primary btn-sm"></input>
				</form>
			</div>
		</div>
		...
		<div class="container">
			<c:if test="${fn:length(bookingList) gt 0}">
				<table id="bookingList" class="display"
						...
						<c:forEach var="bookings" items="${bookingList}">
							<c:forEach var="bookingDetail" items="${bookings.getBookings()}">
								<tr>
									...
									<td><fmt:formatNumber value="${bookings.total}"
											type="currency" /></td>
