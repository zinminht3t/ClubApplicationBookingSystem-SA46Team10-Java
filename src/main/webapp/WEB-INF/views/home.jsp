...
<body>
    ...
    <div class="container" width="60%" margin-right="10%" margin-left="10%">
        <div id="carouselId" class="carousel slide" data-ride="carousel" width="60%">
            ...
            <div class="carousel-inner" role="listbox" width="60%">
                <div class="carousel-item active" styles="margin-left:auto; margin-right: auto;">
                    <img src="Images/la.jpg" alt="First slide" width="100%" height="420px" styles="margin-left:auto; margin-right: auto;">
                ...
                <div class="carousel-item" styles="margin-left:auto; margin-right: auto;">
                    <img src="Images/chicago.jpg" alt="Second slide" width="100%" height="420px" styles="margin-left:auto; margin-right: auto;">
                    <div class="carousel-caption d-none d-md-block">
                        <button class="default" type="submit">Read More</button>
                    </div>
                </div>
                <div class="carousel-item" styles="margin-left:auto; margin-right: auto;">
                    <img src="Images/ny.jpg" alt="Third slide" width="100%" height="420px" styles="margin-left:auto; margin-right: auto;">
                    <div class="carousel-caption d-none d-md-block">
                        <button class="default" type="submit">Read More</button>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <img src="Images/WhatsappImage.jpeg" class="card-img-top card-fluid" />
...
<p>+65-1234 5678</p>
    ...
    <footer>
        ...
        <!-- Copyright -->
        <div class="footer-copyright text-center py-3">© 2018 Copyright: GDIP SA46 - Team 12
        </div>
        <!-- Copyright -->
    ...
    <script>
        function initMap() {
            ...
            var myLatLng = { lat: 1.2921820, lng: 103.7766000 };
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js" integrity="sha384-smHYKdLADwkXOn1EmN1qk/HfnUcbVRZyYmZ4qpPea6sjB/pTJ0euyQp0Mk8ck+5T"
        crossorigin="anonymous"></script>
    <!--Google Map API Key-->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCqotvyyArrgsFiiKdRZvGazSRywjI7cds&callback=initMap">
    </script>
