	...
	<form:form method="POST" commandName="maintenance"
		...
		<div class="container">
			...
			<div class="row btn-group">
				...
				<label class="control-label col-md-6"><strong>Start
						Date</strong></label>
				...
				<div class="col-md-6">
					...
					<fmt:formatDate value="${startdate.date}" pattern="yyyy-MM-dd"
						var="formattedDate" />
					<form:input id="datepicker_start" path="startdate" type="text"
			...
			<div class="row btn-group">
				...
				<label class="control-label col-md-6"><strong>End
						Date</strong></label>
			...
			<div class="row btn-group">
				...
				<label class="control-label col-md-7"><strong>Start
						Time</strong></label>
			...
			<div class="row btn-group">
				...
				<label class="control-label col-md-7"><strong>End
						Time</strong></label>
			...
			<div class="row btn-group">
				...
				<div class="col-md-6">
					<input class="btn btn-danger" id="btnReset" type="reset"
						value="Reset" />
				</div>
			</div>
