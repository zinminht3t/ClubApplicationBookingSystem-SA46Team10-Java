...
<body>
	...
	<div class="container">
		...
		<c:if test="${fn:length(facilitylist) gt 0}">
				<table id="faclist" class="display" style="width: auto; padding-left:10px; padding-right:10px; font-size: 12px;">
				...
				<tbody>
					<c:forEach var="facility" items="${facilitylist}">
						<tr>
							...
							<td><fmt:formatNumber value="${facility.price}"
									type="currency" /></td>
							...
							<td><a
								href="${pageContext.request.contextPath}/admin/facility/FacilityFormEdit/${facility.facilityID}">
										<i class="fa fa-edit text-danger fa-2x"></i></a></td>
		...
		<div class="mx-auto" style="width: 150px;">
			<a
				href="${pageContext.request.contextPath}/admin/facility/FacilityFormNew">
				<button type="button" class="btn btn-warning btn-xs"
					style="margin-left: 20px">Add New Facility</button>
			</a>
		</div>
