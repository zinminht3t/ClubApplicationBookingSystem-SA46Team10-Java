...
<body>
	...
	<div class="container">
		...
		<br> <br> <br> <a
			href="${pageContext.request.contextPath}/admin/viewMaintenances"></a>
		...
		<div class="row text-center">
			...
			<div class="col-sm-6 col-md-2">
				<form action="${pageContext.request.contextPath}/admin/viewCalendar">
					<input id="btn-show-calendar" type="submit" name="btnShowCalendar"
						value="Display Calendar" class="btn-primary btn-sm"></input>
				</form>
			</div>
			<div class="col-sm-6 col-md-2">
				<form action="${pageContext.request.contextPath}/admin/viewBookings">
					<input id="btn-show-bookings" type="submit" name="btnShowBookings"
						value="Display Bookings" class="btn-primary btn-sm"></input>
				</form>
			</div>
		</div>
		...
		<div class="container">
			<c:if test="${fn:length(maintenanceList) gt 0}">
				<table id="maintenanceList" class="display"
					...
					<tbody>
						<c:forEach var="maintenance" items="${maintenanceList}">
							<tr>
								...
								<td><a
									href="${pageContext.request.contextPath}/admin/viewMaintenances/MaintenanceFormEdit/${maintenance.getMaintenanceid()}">
		...
		<div>
			<a
				href="${pageContext.request.contextPath}/admin/viewMaintenances/MaintenanceFormNew">
